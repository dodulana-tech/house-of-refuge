...
const MENU = {
  admin: [
    { icon: '📊', to: '/d', label: 'Overview', end: true },
    { icon: '📋', to: '/d/admissions', label: 'Admissions' },
    { icon: '🏥', to: '/d/patients', label: 'Patients' },
    { icon: '👥', to: '/d/staff', label: 'Staff' },
    { icon: '💰', to: '/d/finance', label: 'Finance' },
    { icon: '📈', to: '/d/reports', label: 'Reports & M&E' },
    { icon: '⚙️', to: '/d/settings', label: 'Settings' },
  ],
  staff: [
    { icon: '📊', to: '/d', label: 'Overview', end: true },
    { icon: '📁', to: '/d/caseload', label: 'My Caseload' },
    { icon: '🏥', to: '/d/patients', label: 'Patient Records' },
    { icon: '📅', to: '/d/schedule', label: 'Daily Schedule' },
    { icon: '🤝', to: '/d/mdt', label: 'MDT Reviews' },
    { icon: '⚠️', to: '/d/incidents', label: 'Incidents' },
    { icon: '📝', to: '/d/notes', label: 'Clinical Notes' },
  ],
  patient: [
    { icon: '🏠', to: '/d', label: 'My Dashboard', end: true },
    { icon: '✅', to: '/d/checkin', label: 'Daily Check-in' },
    { icon: '📋', to: '/d/treatment', label: 'Treatment Plan' },
    { icon: '🍽️', to: '/d/meals', label: 'Meals' },
    { icon: '💳', to: '/d/payments', label: 'Payments' },
  ],
  family: [
    { icon: '📊', to: '/d', label: 'Progress', end: true },
    { icon: '📅', to: '/d/visits', label: 'Visit Requests' },
    { icon: '📚', to: '/d/resources', label: 'Family Resources' },
  ],
}
