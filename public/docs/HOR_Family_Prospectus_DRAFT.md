# House of Refuge — Family Prospectus

**Status:** DRAFT v0.1 for stakeholder review
**Date:** 5 May 2026
**Audience (when published):** Prospective families considering residential treatment
**Audience (this draft):** HOR leadership, Freedom Foundation board, ConsultForAfrica management, clinical advisors
...
The family-facing prospectus for House of Refuge — the marketing and conversion document that prospective families will read before deciding to apply. Served on the website at `/prospectus` and available as a printable PDF on request.

### What's in this draft (sections 1–5)
1. **Hero & positioning** — opens the conversation
2. **Suitability** — the Willingness Gateway, inclusion criteria, honest exclusions
3. **The 12-week pathway** — four-phase clinical model with family touchpoints
4. **Joining HOR** — programme fees, the 5-stage admission flow, deposit mechanics, full refund policy, waitlist hold rules
5. **A day in the life — meals** — food as part of the medicine; tier menu mechanics

### What is NOT yet in this draft (sections 6–11)
6. The full daily schedule (5:30 AM wake-up to 11:00 PM lights-out)
7. Family involvement (visitation, family therapy cadence, pass system)
8. Outcomes & aftercare (24-month post-discharge monitoring, alumni programme)
9. Facility & staff (org structure, clinical credentials, governance)
10. FAQs (the questions families repeatedly ask)
11. Final CTA + contact details

### What changed from the published Pricing PDF (now stale)
| Item | Old (PDF) | New (this draft) |
|---|---|---|
| Deposit | NGN 1M fully refundable, applied to Month 1 | NGN 1M split: 400k assessment fee + 600k held toward Month 1 |
| Clinical assessment | Separate NGN 150,000 on admission | Folded into the 400k |
| Processing fee | Separate NGN 50,000 on admission | Folded into the 400k |
...
| Launch date | "Launching April 2026" | "Launching May 2026" (tentative) |
...
2. **Pricing presentation** — is it appropriate to publish fees this transparently? (Recommendation: yes — it's a trust signal for the audience HOR is serving.)
3. **Deposit mechanics** — are the locked rules operationally workable for the clinical and admissions teams?
4. **Refund policy** — are we comfortable with the 50% bed-hold cancellation within 14 days, and the 80% Month 1 cooling-off?
5. **Sections 6–11 priorities** — what should be drafted next?

### Open items still to lock
- The full daily schedule (we have it in the SOPs, just not yet in copy here)
- Family visitation and pass details — should we publish the conduct-based earning system, or keep that operational detail off the prospectus?
- Outcomes data — do we have anything anonymised from peer facilities or pilots we can cite, or do we launch v1 without numbers?
...
# 1. When your family needs more than hope.
...
# 2. Is House of Refuge right for your loved one?

We do not admit every applicant. Recovery is not something that can be done *to* a person — it is something we walk through *with* them. The willingness of the person seeking treatment is the single most important factor in long-term recovery, and it is the very first thing we assess.

## The Willingness Gateway

**Voluntary willingness is non-negotiable.**

Before any clinical assessment, our team holds a structured conversation with your loved one — assessing readiness for change using the URICA framework and motivational interviewing. **If they are not yet willing, we do not force admission.** Instead, we offer an **Outpatient Engagement Pathway** to meet them where they are. We never simply turn a family away.

## Five Inclusion Criteria

All five must be met for residential admission.
...
## Conditions we cannot safely treat in residence
...
# 3. Twelve weeks. Four phases. One clinically-led pathway.
...
## Phase One — Medical Stabilization (Weeks 1–2)
...
> **Family touchpoint:** Welcome call within 72 hours. Orientation pack delivered. Visitation begins from Week 2.

## Phase Two — Therapeutic Foundation (Weeks 3–6)
- Group CBT and relapse-prevention work
- Weekly 1:1 counselling (daily on Signature tier)
- Psychoeducation, life skills, fitness
- Week 4 multidisciplinary treatment review

> **Family touchpoint:** First family therapy session by Week 4. Sunday visitation each week. Treatment review report shared.

## Phase Three — Deepening & Skills (Weeks 7–10)
- Trauma processing and family-systems work
- Vocational assessment and planning
- Personal Relapse Prevention Plan (PRPP)
- Week 8 progress review with the multidisciplinary team

> **Family touchpoint:** Family-systems sessions deepen. 24-hour and 48-hour passes become available based on conduct.

## Phase Four — Reintegration (Weeks 11–12)
- Pre-discharge clinical assessment
- Aftercare and reintegration plan
- Graduation ceremony
- Alumni Programme enrolment

> **Family touchpoint:** Pre-discharge family meeting. Graduation ceremony. Year-one aftercare schedule confirmed.
...
# 4. Programme fees, admission flow, and exactly how your money is held.
...
### Signature — NGN 4,500,000 / month
*3 beds · always limited · 3-month total NGN 13,500,000*
...
Five stages between your first call and your loved one's first day. Each is documented; nothing happens behind closed doors.

### 1. Self-assessment
*Free · About 30 minutes online.*
You complete a structured intake form online — substance history, medical history, family context, willingness for treatment. This becomes the working file for the clinical team.

### 2. Deposit
*NGN 1,000,000 · After self-assessment review.*
Once the file passes initial review, you're invited to pay the 1M deposit. This unlocks the psychiatrist's clinical assessment and reserves your place. The deposit is split — 400k assessment fee plus 600k held toward Month 1 (full breakdown below).
...
## The 1M deposit, plain — where every Naira goes

### NGN 400,000 — Clinical assessment fee
- Psychiatrist consultation
- Diagnostics and clinical workup
- Multidisciplinary case review
- Written admission decision and a referral if declined

*Consumed once the psychiatrist begins your file.*

### NGN 600,000 — Held toward Month 1
...
| You decline a slot offer once it's made | **600k refunded**; place released, no haggling |
| Within 72 hours of admission, your loved one withdraws | **80%** of total Month 1 paid refunded; 400k not refundable |
...
- **Monthly check-in.** The admissions team contacts you each month to confirm continued interest. Two missed monthly contacts and we release the hold and refund the 600k.
- **Withdraw whenever you need to.** You can leave the waitlist at any time — by phone, email, or in person. 600k refunded in full.
- **One decline is a clean exit.** If a slot is offered and you decline it, we treat that as your decision and refund the 600k. No haggling.
- **Re-assessment after 6 months.** Clinical assessments age. If you wait beyond six months, a brief re-assessment (NGN 100,000) updates the clinical file before admission.

*If anything in this section is unclear, or you'd like to talk through your specific situation, the admissions team responds in confidence within one working day.*

---

# 5. The rhythm of recovery, plate by plate, hour by hour.
...
**Every dietary need is accommodated** — halal, vegetarian, diabetic, hypertensive, allergy-led — without families needing to negotiate it. The clinical and catering teams agree the resident's plan at intake, and adjust it through the programme as recovery progresses.

### A note on tiers

Signature residents eat off the **Signature menu** — broader, with additional protein options and weekend specials routed through the CookedIndoors platform. Premium residents eat off the **Premium menu**, fresh and varied, with the option to upgrade to full Signature menu access for any month at NGN 30,000. The clinical team reviews every plate; every dietary need is met regardless of tier. **The medicine doesn't change.**

---

# Sections still to come (drafts pending)

## 6. The full daily schedule
A walk through 5:30 AM wake-up to 11:00 PM lights-out — boot camp, prayer, Bible school, group therapy, life skills, vocational time, individual counselling, sports, evening chapel.

## 7. Family involvement
- Sunday visitation (12–6 PM, designated areas, max 6 hours)
- Family therapy cadence (varies by tier)
- The 4-tier pass system (3-hour, 24-hour, 48-hour weekend, emergency)
- How families stay informed about treatment progress

## 8. Outcomes & aftercare
- Six graduation criteria (clinical stability, behavioural compliance, psychological readiness, relapse prevention competence, spiritual formation, reintegration readiness)
- 24-month post-discharge monitoring protocol
- Alumni Programme (mentorship, support groups, continued counselling access)
- The four discharge types (planned, administrative, clinical, self-discharge)

## 9. Facility & staff
- Org structure (Executive Director → Advisory Board → Programme Director → Programme Manager + Chaplain + Head of Clinical Services + Admin + House Masters + Head Nurse)
- Clinical credentials and governance
- Lagos MOH licensing, NDLEA registration, professional bodies

## 10. FAQs
The questions families have actually asked, answered honestly. Topics: confidentiality, what to bring, contact during detox, dietary, medication management, what counts as relapse, post-discharge realities.

## 11. Final CTA + contact
Admissions phone, application link, in-person facility tour requests, communications protocol.
...
- **Clinical protocols:** WHO / UNODC
- **Faith integration:** Christ-centred, Freedom Foundation Initiative
- **Management:** ConsultForAfrica
- **Catering:** CookedIndoors (tiered menu platform)
- **Admissions:** 0911 277 7600 · houseofrefugeng.org
- **Launch:** May 2026 (tentative)

---

*End of draft v0.1. Comments and revisions welcome — please return marked-up to the project lead.*
