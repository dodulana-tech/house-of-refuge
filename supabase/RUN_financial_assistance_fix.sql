-- ============================================================================
-- FIX: "Could not find the table 'public.financial_assistance_applications'"
-- Run this whole file in the Supabase dashboard → SQL Editor, then submit form.
-- Combines, in order:
--   1) 20260514_financial_assistance.sql        (creates the table + bucket)
--   2) 20260514_pastoral_interview_tracking.sql (adds pastoral columns)
...
-- ---------------------------------------------------------------------------
-- 2) Pastoral interview tracking (adds columns the admin flow reads)
-- ---------------------------------------------------------------------------
...
-- select count(*) from financial_assistance_applications;
